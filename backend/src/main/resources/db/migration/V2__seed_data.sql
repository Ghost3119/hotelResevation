...
--
-- Las cuentas de acceso NO se crean mediante Flyway. El bootstrap opcional del
-- backend toma sus valores de secretos de entorno y almacena unicamente BCrypt.
-- De esta forma una base nueva nunca nace con credenciales publicas conocidas.
...
VALUES (1, 1, 100.00, 'CASH', 'COMPLETED', 'SEED-0001', now(), NULL);
